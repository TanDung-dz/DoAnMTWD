...
namespace DoAnMTWD
{
    public partial class PhieuXetNghiem : Form
    {
        ...
        public void ThemThongTin(string maBN, string hoTen, DateTime ngayKham, string makt, string ketqua)
        {
            ...
            dgv_TTPXN.Rows.Add(maBN, hoTen, ngayKham, makt, ketqua);
        ...
        private void btn_Inpxn_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow row in dgv_TTPXN.Rows)
            {
